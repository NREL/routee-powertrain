...
def plot_feature_importance(estimator):
    ...
    if isinstance(estimator, XGBoost):
        ...
        pd.Series(plot_model.feature_importances_, index=features).nlargest(10).plot(kind='barh')
        ...
        raise TypeError("Can only plot feature importance for XGBoost and RandomForest estimators")
