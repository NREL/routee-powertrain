...
The Feature_Selection module resides inside the feature_engineering folder. To import the module, use--> from powertrain.core.model import Feature_Selection
"""
...
from powertrain.core.feature_selection import (
    Feature_Selection,
)  # importing the Feature_Selection Module
...
"""
feat_obj.get_optimal_features(
    target_feature="gge", estimator=RandomForestRegressor(), search_method="rfe"
)
# ------------------------------
"""
...
"""
feat_obj.get_optimal_features(
    target_feature="gge", estimator=RandomForestRegressor(), search_method="fsfs"
)
