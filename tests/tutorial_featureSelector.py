...
from powertrain.core.feature_selection import Feature_Selection  # importing the Feature_Selection Module
...
'''
feat_obj.get_correlation(method='pearson', target_feature='gge', threshold=0.4, multicolinearity=False,
...
'''
feat_obj.get_correlation(method='pearson', target_feature='frc', threshold=0.4, multicolinearity=True,
                         show_correlation=False)
...
'''
feat_obj.get_correlation(method='kendall', target_feature='frc', threshold=0.4, multicolinearity=False,
